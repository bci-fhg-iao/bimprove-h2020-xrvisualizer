// source: http://wiki.unity3d.com/index.php?title=SetPivot
 ...
 * - toggle to pivot-mode (Key "Z" or via GUI)
 * - GUI: GameObject -> Set Pivot
 * - adjust values using sliders / press center
 */
...
public class SetPivot : EditorWindow
{
    ...
    [MenuItem("IAO-Workflow/Set Pivot")] //Place the Set Pivot menu item in the GameObject menu
    static void Init()
    {
